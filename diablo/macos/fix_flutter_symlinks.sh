#!/bin/bash
# Fix invalid symlinks in Flutter.framework before archiving
# This prevents ITMS-90332 errors during App Store submission

set -e

echo "🔧 Fixing Flutter framework symlinks..."

# Find the Flutter.framework in the app bundle
APP_BUNDLE="${BUILT_PRODUCTS_DIR}/${PRODUCT_NAME}.app"
FLUTTER_FRAMEWORK="${APP_BUNDLE}/Contents/Frameworks/Flutter.framework"
