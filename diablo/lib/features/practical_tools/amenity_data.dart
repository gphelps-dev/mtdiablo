...
class AmenityData {
  static List<Amenity> get amenities => [
    ...
    Amenity(
      ...
      description: 'Clean restroom facilities near the main trailhead.',
      isOpen: true,
      hours: 'Sunrise to Sunset',
    ...
    Amenity(
      ...
      description: 'Restroom facilities at the summit visitor area.',
      isOpen: true,
      hours: 'Sunrise to Sunset',
      features: ['Handicap Accessible', 'Running Water'],
    ),
    ...
    Amenity(
      ...
      description: 'Drinking water available at the trailhead.',
      isOpen: true,
      hours: '24/7',
    ...
    Amenity(
      ...
      description: 'Drinking water at the summit visitor area.',
      isOpen: true,
      hours: '24/7',
      features: ['Potable Water', 'Refill Station'],
    ),
    ...
    Amenity(
      ...
      description: 'Shaded picnic area with tables and grills.',
      isOpen: true,
      hours: 'Sunrise to Sunset',
    ...
    Amenity(
      ...
      description: 'Picnic area with spectacular views of the Bay Area.',
      isOpen: true,
      hours: 'Sunrise to Sunset',
    ...
    Amenity(
      ...
      description: 'Visitor center with exhibits, maps, and park information.',
      isOpen: true,
    ...
    Amenity(
      ...
      description: 'Emergency phone for park rangers and emergency services.',
      isOpen: true,
      hours: '24/7',
    ...
    Amenity(
      ...
      description: 'First aid supplies and emergency medical equipment.',
      isOpen: true,
      hours: '24/7',
